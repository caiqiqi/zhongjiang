今天在空间里看到一个这个网站，想去看看是个什么情况，诱导几个同学分享了它们的页面。![这](http://houjiang.dgyfsd.com/zhuanpan/)是它们的网站首页。看了一下，整个页面能给用户看到的就是一张图片而已(好吧，可能人家是专为手机用户设计的呢，知道晚上那么晚了看这个的应该是用手机吧)，</br>
